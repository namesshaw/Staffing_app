...
router.post("/addskills", devAuth, async(req : DeveloperRequest, res : Response) => {
    
        const skills:Skill[] = req.body.skills as { name: string, proficiency: string, developer_id : string }[]
...
router.put("/edit", devAuth, async(req, res) => {
