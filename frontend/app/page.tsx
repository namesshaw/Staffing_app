    ...
    <div className="bg-gradient-to-br from-blue-50 via-white to-cyan-50 min-h-screen flex flex-col overflow-x-hidden">
      ...
      <main className="flex-grow">
        ...
        <section className="relative flex flex-col items-center justify-center text-center py-48 px-4">
          ...
          <motion.a
            href="/signup"
            className="px-8 py-4 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 text-white text-lg font-bold shadow-lg hover:shadow-2xl hover:scale-110 transition"
        ...
        <section id="features" className="py-32 bg-white">
          <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-16 text-center">
            {['Fast', 'Elegant', 'Scalable'].map((feature, idx) => (
              <motion.div
                key={idx}
                className="p-8 rounded-3xl shadow-md hover:shadow-2xl transition bg-gradient-to-tr from-blue-50 to-cyan-50"
        ...
        <section id="contact" className="py-32 bg-white">
          <div className="max-w-4xl mx-auto text-center px-6">
            ...
            <motion.a
              href="/contact"
              className="px-6 py-3 rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 text-white text-lg font-bold shadow-md hover:scale-110 hover:shadow-2xl transition"
              whileHover={{ scale: 1.1 }}
            >
              Contact Us
            </motion.a>
